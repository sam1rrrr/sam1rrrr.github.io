...
const COMMANDS = {
    help: 'Команды : <span class="code">about</span>, <span class="code">contact</span>, <span class="code">updates</span>, <span class="code">game</span>, <span class="code">draw</span>, <span class="code">2048</span>, <span class="code">barsik</span>, <span class="code">clear</span>'
    , about: "Copyright © Nedosite 2018-2020"
    , contact: "Соцсети:<br><a href='https://vk.com/sam1rrrr' class='success link'>Vkontakte</a>, <a href='https://www.github.com/sam1rrrr' class='success link'>Github</a>, <a href='https://www.t.me/sam1rrrr' class='success link'>Telegram</a>"
...
const execute = function executeCommand(input) {
    ...
    if (input == 'game -r') {
        setTimeout(() => {
            document.location.href = "./gаme.html";
        }, 1000);
    }
    if (input == '2048') {
        setTimeout(() => {
